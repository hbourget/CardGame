    ...
    columns: [
      ...
      { data: 'image' },
      {
        ...
        render: function (data, type, row) {
          return (
            "<form class='buy-form' action='http://localhost:8888/inventories/buy/users/1/cards/" +
            row.id +
            "' method='post'>" +
      ...
      },
      {
        ...
        render: function (data, type, row) {
          return (
            "<form class='sell-form' action='http://localhost:8888/inventories/sell/users/1/cards/" +
            row.id +
            "' method='post'>" +
